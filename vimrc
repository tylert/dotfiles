...
set showcmd       "display useful stuff when in visual line mode
set visualbell    "flash the screen instead of beeping

set scrolloff=10  "provide n lines of context
...
set shiftwidth=4  "shift n characters left or right using < or >
set tabstop=4     "show tabs as n spaces wide
...
set nosmartindent  "and certainly don't do it while after { or } either
"set nocindent
